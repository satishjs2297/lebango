        ...
        <div class="accordion">
            ...
            <div class="full-width">
			               <table class="mt-3"> 
					          	 <tr>
								    <th width="">Name</th>
								    <th width="">Customer Information</th>
					          ...
					          <table>
								  <tr class="bg">
								    <td width="14%">Demo</td>
								    <td width="41%">Lorem Ipsmu Dolar</td>
								    <td width="19%">Germany</td>
								    <td width="12%">Demo</td>
								    <td><a href="edit.html" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> <a href="#" data-toggle="tooltip" data-placement="top" title="Delet"> <i class="fa fa-trash-o"></i></a> <a href="#" id="view" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-angle-down"></i></a></td>
								  </tr>
								</table>
								<script type="text/javascript">
									...
									<div class="border-1 one">
									   <p><strong>Details</strong></p>
									     <div class="full-width mt-2">
									       ...
									       <div class="col-md-3 col-sm-3">
									         <h4>Qualification</h4>
									         <img src="<c:url value="/resources/img/file-uplod.png" />" class="mt-img">
			...
			<div class="full-width">
					          <table>
								  <tr>
								    ...
								    <td width="19%">Germany</td>
								    <td width="12%">Demo</td>
								    <td><a href="edit.html" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> <a href="#" data-toggle="tooltip" data-placement="top" title="Delet"> <i class="fa fa-trash-o"></i></a> <a href="#" id="viewt" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-angle-down"></i></a></td>
								  </tr>
								</table>
								<script type="text/javascript">
									$(document).ready(function(){

            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form:form method="POST" action="register-car"  modelAttribute="carEntity.car" enctype="multipart/form-data"  class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <form:select id="locationId" path = "location_id" class="form-control" >
					...
					<c:if test="${not empty carEntity.carhour_array}">
						<div class="form-group">
							<form:label path="availableDays"
								class="control-label col-md-3 col-sm-3 col-xs-12">Available Days<span
									class="required">*</span>
							</form:label>
							<table id="datatable"
								...
								<tbody>
									<c:forEach items="${carEntity.carhour_array}"
										var="carHour">
										<tr>
											<td><label>${carHour.start_time}</label></td>
											<td><label>${carHour.end_time}</label></td>
											<td><a href="javascript:confirmDelete(${carHour.id});"

            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-book"></i> Bookings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display:block;">
                      <li class="current-page"><a href="upcoming-bookings">Upcoming Bookings</a></li>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>${tourbooking.tour_code}</td>
                          <td>${tourbooking.booking_id}</td>
                          <td>${tourbooking.state}</td>
                          <td>${tourbooking.trace}</td>
                          <td>${tourbooking.start_date}</td>
                          <td>${tourbooking.end_date}</td>
                          <td>${tourbooking.contact_person}</td>
                          <td>
                            <button type="button" class="btn btn-success btn-xs">${tourbooking.tour_status_name}</button>
                          </td>
                          <td>

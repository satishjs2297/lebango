                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-automobile"></i> Cars <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display:block;">
                      <li class="current-page"><a href="manage-car">Manage Cars</a></li>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <c:forEach var="model" items="${cars}">
                        <tr>
                          <td>${model.car.number}</td>
                          <td>${model.car.brand}</td>
                          <td>${model.car.model}</td>
                          <td>${model.car.product_year}</td>
                          <td>${model.car.seat}</td>
                          <td>
                            <a href="viewcar?id=${model.car.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="edit-car?id=${model.car.id}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="javascript:confirmDelete(${model.car.id});" class="btn btn-danger btn-xs">
	       ...
	       <div class="modal-dialog" style="color:black;">
	         <div class="modal-content">
	           ...
	           <div class="modal-body">
	             <h4>Do you want to delete this car #<span id="car_id_value"></span>?</h4>

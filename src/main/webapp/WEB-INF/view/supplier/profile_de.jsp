	  ...
	  <nav class="navbar navbar-expand-lg navbar-light fixed-hader">
	   <div class="full-width">
		  <a class="navbar-brand" href="#">
		  	 <img src="<c:url value="/resources/img/logo.png" />" class="mt-img">
		  </a>
				       ...
				       <h4 class="hadding">Your Detail</h4>
					         ...
					         <div class="full-width text-left mt-4">
							  ...
							  <div class="full-width text-left mt-2">
							       <div class="col-md-6 col-sm-6">
							         <p>Email Address</p>
							         <input type="text" class="form-control" placeholder="Email Address" name="">
							       </div>
							       <div class="col-md-6 col-sm-6">
							         <p>Repeat Email Address</p>
							         <input type="text" class="form-control" placeholder="Repeat Email Address" name="">
							       </div>
							  </div>  
							  <div class="full-width text-left mt-2">
							       <div class="col-md-6 col-sm-6">
							 ...
							 <div class="Col-md-12 col-sm-12">
							   <p><strong>Qualification Information</strong></p>
							 </div>  
							     ...
							     <div class="full-width">
									  ...
									  <div class="full-width text-center">
							             <a href="#" class="btn btn-primary pull-right mt-3" id="nexttwo">Done</a>
							          </div>
							    </div>
						    </div> 						  
					     </div>
...
<ul class="left-menue">
	...
	<li><a href="locations"><i class="fa fa-hand-paper-o"></i> Upcoming Booking <i class="fa fa-angle-right pull-right"></i></a></li>
	<li><a href="locations"><i class="fa fa-hand-paper-o"></i> Finished Booking <i class="fa fa-angle-right pull-right"></i></a></li>

  ...
  <div class="container">
    <div class="row">
        <div class="accordion">
          ...
          <table class="mt-3">
          	 <tr>
			    <th width="22%">Guide ID</th>
			    <th width="22%">Location</th>
			    <th width="16%">Guide Name</th>
          ...
          <table>
			  <tr class="bg">
			    ...
			    <td>Demo</td>
			    <td>Toyta</td>
			    <td><a href="edit-guid" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> <a href="#" data-toggle="tooltip" data-placement="top" title="Delet"> <i class="fa fa-trash-o"></i></a> <a href="#" id="view" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-angle-down"></i></a></td>
			  </tr>
			</table>
			<script type="text/javascript">
				...
				<div class="border-1 one">
				   ...
				   <div class="full-width mt-3">
				      <div class="col-20">
				        <div class="img-uplod">
				          <img src="<c:url value="/resources/img/user-image.png" />" class="img-fluid">
			...
			<table>
			  <tr>
			    ...
			    <td>Demo</td>
			    <td>Toyta</td>
			    <td><a href="edit-guid" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> <a href="#" data-toggle="tooltip" data-placement="top" title="Delet"> <i class="fa fa-trash-o"></i></a> <a href="#" id="viewtwo" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-angle-down"></i></a></td>
			  </tr>
			  </table>
			  <script type="text/javascript">
				$(document).ready(function(){
					$('#viewtwo').click(function(){
						$('.three').toggle()
						$('#viewtwo').toggleClass('rotate')
					});
				});
			</script>
			  <div class="border-1 three">
				   <p><strong>Avilabel Time</strong></p>
				   <div class="full-width">
				      <div class="col-md-8 col-sm-8">
				        <div class="row">
						   <div class="col-md-4 col-sm-4">
			  ...
			  <tr class="bg">
			   <td>CO44568</td>
			    ...
			    <td>Demo</td>
			    <td>Toyta</td>
			    <td><a href="edit-guid" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> <a href="#" data-toggle="tooltip" data-placement="top" title="Delet"> <i class="fa fa-trash-o"></i></a> <a href="#" id="viewthree" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-angle-down"></i></a></td>
			  </tr>
			  </table>
			  <script type="text/javascript">
				$(document).ready(function(){

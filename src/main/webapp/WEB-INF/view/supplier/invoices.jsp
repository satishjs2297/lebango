            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <!-- <h3>Sub title</h3> -->
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="invoices"><i class="fa fa-credit-card"></i> Invoices </a></li>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <c:forEach var="model" items="${invoices}">
                        <tr>
                          <td>${model.invoice_code}</td>
                          <td>${model.tour_code}</td>
                          <td>${model.booking_id}</td>
                          <td>${model.amount}</td>
                          <td>${model.service_fee}</td>
                          <c:choose>
	                          <c:when test="${model.method==1}">
	                          	<td> Paypal </td>
	                          </c:when>
	                          <c:otherwise>
	                          	<td> Alipay </td>
                          ...
                          <c:choose>
					         ...
					         <c:when test = "${model.status == 2}">
					            <td>
					            		<button type="button" class="btn btn-success btn-xs">Denied</button>
					            </td>
					         </c:when>
					         <c:otherwise>
					            <td>
                          ...
                          <td>
                            <a href="detail-invoice?invoice_id=${model.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                          </td>
                        </tr>
                        </c:forEach>
                        </c:if>

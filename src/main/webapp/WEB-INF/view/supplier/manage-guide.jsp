                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-user"></i> Guides <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display:block;">
                      <li class="current-page"><a href="manage-guide">Manage Guide</a></li>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <c:forEach var="model" items="${guides}">
                        <tr>
                          <td>${model.firstname}</td>
                          <td>${model.lastname}</td>
                          <!-- 
                          <td>
                          	<img src='<c:url value="${model.photo}" />' style="width: 100px;height: 100px;" />
                          </td>
                          -->
	       ...
	       <div class="modal-dialog" style="color:black;">
	         <div class="modal-content">
	           ...
	           <div class="modal-body">
	             <h4>Do you want to delete this guide #<span id="guide_id_value"></span>?</h4>

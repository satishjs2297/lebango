...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form:form  modelAttribute="carEntity.car"  class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <form:input path="number" type="text" class="form-control" placeholder="input plate number" readonly="true"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <form:label path="brand" class="control-label col-md-3 col-sm-3 col-xs-12">Brand<span class="required">*</span></form:label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <form:input path="brand" type="text" class="form-control" placeholder="input brand" readonly="true"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <form:label path="model" class="control-label col-md-3 col-sm-3 col-xs-12">Model<span class="required">*</span></form:label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <form:input path="model" type="text" class="form-control" placeholder="input model" readonly="true"/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <form:input path="product_year" type="text" class="form-control" placeholder="input production year" readonly="true"/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <form:select path="seat" class="form-control" items="${seatList}" readonly="true"/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <form:select id="locationId" path = "location_id" class="form-control" readonly="true">
                            <form:options items="${locationList}"/>
                         </form:select>                          
                        </div>
                      </div>
					 <c:if test="${not empty carEntity.carhour_array}">
					  <div class="form-group">
							...
							<table id="datatable"
								...
								<tbody>
									<c:forEach items="${carEntity.carhour_array}" var="carHour">
										<tr>
											<td>
												<label>${carHour.start_time}</label>
											</td>
											<td>
												<label>${carHour.end_time}</label>
											</td>
										</tr>
									</c:forEach>	                            								
								</tbody>
						...
						<c:if test="${not empty carEntity.car.tours}">
	                      <div class="form-group">
	                        ...
	                        <div class="col-md-9 col-sm-9 col-xs-12">
								<table id="datatable"
									...
									<tbody>
										<c:forEach items="${carEntity.car.tours}" var="tour"> 									
											<tr>
					 ...
					 <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="button" class="btn btn-primary" id="back-manage-car">Back</button>
                        </div>
                      </div>
	...
	$(document).ready( function() {
		...
		$("#back-manage-car").click(function(){
			console.log('back to manage car initiated...');
			window.location.replace('http://localhost:8080/lebango/supplier/manage-car');	
		});
	});

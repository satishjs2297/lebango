  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
       ...
       <!-- page content -->
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h1><i class="fa fa-globe"></i> Invoice #${invoice_model.invoice.invoice_code}  <small class="pull-right">Date: ${invoice_model.invoice.created_at}</small></h1>
                        </div>
                        <!-- /.col -->
                      </div>
                      <!-- info row -->
                      <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                          From
                          <address>
	                          <strong>${invoice_model.from_user.company_name}</strong>
	                          <!-- 
	                          <br>795 Freedom Ave, Suite 600
	                          <br>New York, CA 94107
	                          <br>Phone: 1 (804) 123-9876
	                           -->
	                          <br>Phone: ${invoice_model.from_user.phone}
	                          <br>Email: ${invoice_model.from_user.email}
	                      </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          To
                          <address>
                              <strong>${invoice_model.to_user.company_name}</strong>
                              <br>Phone: ${invoice_model.to_user.phone}
	                          <br>Email: ${invoice_model.to_user.email}
                          </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                        	 <!-- 
                          <b>Invoice #${invoice_model.invoice.invoice_code}</b>
                          -->
                          <br>
                          <b>Tour Code:</b> ${invoice_model.invoice.tour_code}
                          <br>
                          <b>Payment Due:</b> ${invoice_model.invoice.pay_due_date}
                          <br>
                          <!-- 
                          <b>Account No:</b> 629
                           --> 
                      ...
                      <div class="row">
                        <div class="col-xs-12 table">
                          <table class="table table-striped">
                            ...
                            <tbody>
                            	   <c:if test="${not empty invoice_model.invoice_item_array}">
		                        <c:forEach var="model" items="${invoice_model.invoice_item_array}">
		                        <tr>
		                          <td>${model.quantity}</td>
		                          <td>${model.trace_name}</td>
		                          <td>$ ${model.item_price} per Car</td>
		                          <td>
		                       		<c:if test="${not empty model.order_item_array}">
		                        		<c:forEach var="orderitem" items="${model.order_item_array}">
		                        			Car: ${orderitem.car_name}, ${orderitem.car_seat}s, Guide: ${orderitem.guide_name}
		                        			<br /> 
		                        		</c:forEach>
		                        		</c:if>   	
		                          </td>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          ...
                          <img src="<c:url value="/resources/gentel/images/visa.png" />" alt="Visa">
                          <img src="<c:url value="/resources/gentel/images/mastercard.png" />" alt="Mastercard">
                          <img src="<c:url value="/resources/gentel/images/american-express.png" />" alt="American Express">
                          <img src="<c:url value="/resources/gentel/images/paypal.png" />" alt="Paypal">	
                          <!-- 	
                        ...
                        <!-- /.col -->
                        <div class="col-xs-6">
                          <p class="lead">Amount Due ${invoice_model.invoice.pay_due_date}</p>
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                <tr>
                                  <th style="width:50%">Subtotal:</th>
                                  <td>$ ${invoice_model.invoice.amount}</td>
                                </tr>
                                <tr>
                                  <th>Fee </th>
                                  <td>$ ${invoice_model.invoice.service_fee}</td>
                                </tr>
                                <tr>
                                  <th>Total:</th>
                                  <td>$ ${invoice_model.invoice.amount - invoice_model.invoice.service_fee}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                      ...
                      <div class="row no-print">
                        <div class="col-xs-12">
                          ...
                          <button class="btn btn-primary pull-right" style="margin-right: 5px;" id="generatepdfbtn"><i class="fa fa-download"></i> Generate PDF</button>
                        </div>
                      </div>
                    </section>
                  </div>
		...
		<!-- Delete modal -->
	     <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="generatePDFModal">
	       <div class="modal-dialog" style="color:black;">
	         <div class="modal-content">
	           <div class="modal-header">
	             <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
	             </button>
	             <h4 class="modal-title" id="myModalLabel2">Confirm Generate</h4>
	           </div>
	           <div class="modal-body">
	             <h4>Do you want to generate PDF and download this invoice?</h4>
	             <p>Once you confirm, it will generate and download automatically.</p>
	           </div>
	           <div class="modal-footer">
	             <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	             <button type="button" class="btn btn-success" id="generatebtn">Generate</button>
	           </div>
    ...
    <script>
      ...
      $( "#generatebtn" ).click(function() {
	    	  window.location.href="generate-pdf?invoice_id=1";
	  });
    </script>

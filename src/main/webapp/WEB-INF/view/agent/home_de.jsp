...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-hader">
			<div class="full-width">
				<a class="navbar-brand" href="#"><img
					src="<c:url value="/resources/img/logo.png" />" class="mt-img"></a>
				...
				<div class="collapse navbar-collapse dashboard"
					...
					<ul class="navbar-nav mr-auto text-right ">
						<li class="nav-item"><a class="nav-link" href="account.html">Account</a>
						</li>
	...
	<div class="home-page">
		<div class="container">
			<div class="row">
				<div class="accordion">
					<div class="full-width border-bottom-2">
						<h4>Super Admin Dashboard</h4>
						<div class="col-md-6 col-sm-6 mt-4">
							<div class="box-border">
								<h4>
									<i class="fa fa-file-text"></i> My Order
								</h4>
								<p>Total: 20</p>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 mt-4">
							<div class="box-border">
								<h4>
									<i class="fa fa-bookmark"></i>Book Order
								</h4>
								<p>Total: 20</p>
							</div>
						</div>

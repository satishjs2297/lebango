            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <!-- <h3>Sub title</h3> -->
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="bookhistory"><i class="fa fa-book"></i> Book History </a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <c:forEach var="model" items="${tourbookings}">
                        <tr>
                          <td>${model.tour_code}</td>
                          <td>${model.state}</td>
                          <td>${model.trace}</td>
                          <td>${model.start_date}</td>
                          <td>${model.end_date}</td>
                          <td>$${model.total_amount} AUD</td>
                          <td>
                          	<button type="button" class="btn btn-success btn-xs">${model.book_status_name}</button>
                          </td>
                          <td>${model.contact_person}</td>
                          <td>
                            <a href="detail-booking?booking_id=${model.booking_id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                          </td>
                        </tr>
                        </c:forEach>
                        </c:if>
